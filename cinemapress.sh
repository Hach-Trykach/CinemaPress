...
1_install() {
    ...
    # docker build -t cinemapress/docker https://github.com/hdrezkaby/CinemaPress.git
    ...
    if [ "`docker ps -aq -f status=running -f name=^/nginx\$ 2>/dev/null`" != "" ]; then
        ...
        && [ "`netstat -tunlp | grep :::80`" = "" ]; then
            # docker build -t cinemapress/nginx https://github.com/hdrezkaby/CinemaPress.git#:config/default/nginx
            # docker build -t cinemapress/fail2ban https://github.com/hdrezkaby/CinemaPress.git#:config/default/fail2ban
            # docker build -t cinemapress/filestash https://github.com/hdrezkaby/CinemaPress.git#:config/default/filestash
...
success_install(){
    ...
    _content "Forum: forum.cinemapress.su"
    _content
    _s
}
